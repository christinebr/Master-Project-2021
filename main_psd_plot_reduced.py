...
from plot_psd import psd_torbjorn, psd_graity, \
    psd_from_milstein2009, psd_from_baranauskas2012,\
    psd_from_miller2009
...
for file, color in zip(crcns_files_red, colors_red):
    plot_psd_data(file, color)
